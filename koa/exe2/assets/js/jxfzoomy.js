(function($){
    ...
    $.fn.jxfZoomy.methods = {
            ...
            bindEvent:function(){
                ...
                //注册最下面的小缩略图鼠标进入事件 
                configPara.$container.find('.jxfzoomy-list-img li').on('mouseenter', function (event) {
                ...
                configPara.$container.find('.jxfzoomy-thumb-box .jxfzoomy-thumb-lt').on('click', function (event) {
                    option.moveSpeed = configPara.$container.find('.jxfzoomy-thumb-box .jxfzoomy-thumb-ct ul li').width()+7
            ...
            bindEvent2:function(){
                ...
                configPara.$container.find('.jxfzoomy-small-box-move').on('mousemove', function (event) {
                    maskLeft = event.pageX - $(this).offset().left - configPara.$mask.width() / 2
                    maskTop = event.pageY - $(this).offset().top - configPara.$mask.height() / 2
